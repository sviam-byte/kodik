...
---
**Примечание:** Колонки с 3-й по 8-ю (индексы `2–7`) могут содержать дополнительные анатомические или статистические данные, но не используются при построении топологии графа.
---
